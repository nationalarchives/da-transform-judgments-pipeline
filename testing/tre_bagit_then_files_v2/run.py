...
import tre_validate_bagit_files
import sys
import json
...
result_1 = tre_validate_bagit.handler(event=event, context=context)
print(f'tre_validate_bagit output:\n{json.dumps(result_1, indent=2)}')

result_2 = tre_validate_bagit_files.handler(event=result_1, context=context)
